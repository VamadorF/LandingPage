...
import { CookiesContent } from '../components/contenidoLegal'

export const metadata: Metadata = {
    title: 'Política de Cookies',
    description:
        'Información sobre el uso de cookies en eJoi. Aprende qué tipos de cookies utilizamos y cómo puedes gestionarlas.',
    alternates: {
        canonical: '/cookies',
    },
    robots: {
        ...
        <main className="min-h-screen" style={{ background: 'radial-gradient(ellipse at top center, rgba(186, 176, 237, 0.08) 0%, rgba(255, 255, 255, 0) 60%), #FEFEFE' }}>
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                <nav className="mb-8 text-sm" style={{ color: 'rgba(60, 60, 59, 0.5)' }}>
                    ...
                    <span style={{ color: '#3C3C3B' }}>Política de Cookies</span>
                </nav>
                ...
                <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row gap-3 sm:gap-6 text-sm" style={{ borderTopColor: 'rgba(186, 176, 237, 0.3)', color: 'rgba(60, 60, 59, 0.6)' }}>
                    <Link href="/terminos" className="hover:underline transition-colors" style={{ color: 'rgba(60, 60, 59, 0.6)' }}>
