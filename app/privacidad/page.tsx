...
import { PrivacyContent } from '../components/contenidoLegal'

export const metadata: Metadata = {
    title: 'Política de Privacidad',
    description:
        'Conoce cómo eJoi recopila, usa y protege tus datos personales. Tu privacidad es nuestra prioridad.',
    alternates: {
        ...
        <main className="min-h-screen" style={{ background: 'radial-gradient(ellipse at top center, rgba(186, 176, 237, 0.08) 0%, rgba(255, 255, 255, 0) 60%), #FEFEFE' }}>
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                <nav className="mb-8 text-sm" style={{ color: 'rgba(60, 60, 59, 0.5)' }}>
                    ...
                    <span style={{ color: '#3C3C3B' }}>Política de Privacidad</span>
                </nav>
