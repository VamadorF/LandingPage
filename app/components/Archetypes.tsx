      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
          {archetypes.map((archetype) => (
            ...
            >
              <div className="relative h-56 sm:h-60 md:h-72 lg:h-80 xl:h-96 overflow-hidden flex-shrink-0" style={{ backgroundColor: 'rgba(186, 176, 237, 0.05)' }}>
                {/* Loading skeleton */}
              ...
              <div className="flex-1 flex flex-col p-4 sm:p-5 md:p-5 lg:p-6">
